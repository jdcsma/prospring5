...
@Configuration
@ComponentScan(basePackages = {"jun.prospring5.ch8"})
@EnableJpaRepositories(basePackages = {"jun.prospring5.ch8"})
...
public class JpaConfiguration {
    ...
    private Properties hibernateProperties() {
        ...
        properties.put(Environment.HBM2DDL_IMPORT_FILES, "database/musicdb.sql");
        properties.put(Environment.HBM2DDL_IMPORT_FILES_SQL_EXTRACTOR,
        ...
        properties.put("org.hibernate.envers.revision_type_field_name",
                "revision_type");
        properties.put("org.hibernate.envers.audit_strategy_validity_end_rev_field_name",
                "revision_end");
        properties.put("org.hibernate.envers.audit_strategy_validity_store_revend_timestamp",
                "true");
        properties.put("org.hibernate.envers.audit_strategy_validity_revend_timestamp_field_name",
                "revision_end_timestamp");
